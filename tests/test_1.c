...
int main() {
    ...
    time_t datetime_for_winter_in_australia = wished_wday_in_choosen_month(year, 3, wday, 3, 0, 0, FIRST);
    printf("%s", asctime(gmtime(&datetime_for_winter_in_australia)));

    //
    printf("Date of first tuesday of October %d : ", year);
    time_t datetime_for_summer_in_australia = wished_wday_in_choosen_month(year, 9, wday, 2, 0, 0, FIRST);
    printf("%s", asctime(gmtime(&datetime_for_summer_in_australia)));

    //
    printf("Date of last tuesday of September %d : ", year);
    time_t datetime_for_summer_in_new_zealand = wished_wday_in_choosen_month(year, 8, wday, 2, 0, 0, LAST);
