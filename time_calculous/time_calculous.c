...
// Definition of the 'n_weekday_in_choosen_year' function to get the datetime of the nth choosen weekday in a choosen year
time_t wished_wday_in_choosen_year(int year, int wday, int number_of_weekday_in_the_year)
{
    ...
    // ========>>> to get the weekday of the last day of the year (wday_of_the_ldy)
